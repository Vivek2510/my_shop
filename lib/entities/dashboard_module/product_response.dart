class MDLProductResponse {
  List<Products>? products;
  int? total;
  int? skip;
  int? limit;

  MDLProductResponse({this.products, this.total, this.skip, this.limit});

  MDLProductResponse.fromJson(Map<String, dynamic> json) {
...
class Products {
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    stock = _toDouble(json['stock']); // Keep as int
    ...
    minimumOrderQuantity = _toDouble(json['minimumOrderQuantity']);
